...
public class Test1 {
    ...
    public static void createPseson() throws Exception {
        ...
        // 1. 创建一个空类
        CtClass cc = pool.makeClass("me.mingshan.agent.Person");
        ...
        ctMethod.insertBefore("long beginTime = System.currentTimeMillis();" );

        System.out.println("在main方法执行之后打印耗时");
        // 在main方法执行之后打印耗时
        // System.out.println("总耗时：" + (System.currentTimeMillis() - beginTime));
        ctMethod.insertAfter("System.out.println(\"总耗时：\" + (System.currentTimeMillis() - beginTime));");

        cc.addMethod(ctMethod);

        //这里会将这个创建的类对象编译为.class文件
        cc.writeFile("D:\\develop\\code\\agent-demo\\");
    }
}
